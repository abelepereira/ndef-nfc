...
namespace NdefLibrary.Ndef {
    ...
    public class NdefExceptionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The NDEF Message format is not valid..
        /// </summary>
        public static string ExInvalidNdefMessageFormat {
            get {
                return ResourceManager.GetString("ExInvalidNdefMessageFormat", resourceCulture);
            }
        }
